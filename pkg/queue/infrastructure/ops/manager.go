...
func NewApplicationOpsConsumer (client bus.NalejClient, name string, exclusive bool, config ConfigInfrastructureOpsConsumer) (*ApplicationOpsConsumer, derrors.Error) {
